...
export class ProgressManager {
  ...
  static getWorldTargets(worldId) {
    const worldNPCs = {
      ...
      beach: [
        { id: "carlos_praia_1", x: 400, y: 600, name: "Carlos" },
        { id: "carlos_praia_2", x: 550, y: 400, name: "Marina" },
      ],
      industrial: [
        { id: "ingrid_cielo_1", x: 300, y: 250, name: "Ingrid" },
        { id: "ingrid_industrial_2", x: 500, y: 400, name: "Roberto" },
      ],
    };
