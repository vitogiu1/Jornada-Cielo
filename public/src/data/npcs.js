  ...
  CeleiroScene: [
    {
      ...
      dialogs: [
        "A safra de grãos já tá no caminhão, pronta pra ir pra outros estados e até pra fora do país.",
        "O problema é cobrar essa gente de longe. É carga de meio milhão de reais, não dá pra brincar com segurança.",
        "Se veio me oferecer maquineta básica de balcão, perdeu a viagem. Eu preciso de um sistema blindado pra vender à distância!",
      ],
    },
  ],
  QuiosquePraiaScene: [
  ...
  QuiosDoisPraiaScene: [
    {
      ...
      name: "Léo dos Frutos do Mar",
      characterKey: "npc_praia",
      x: 512,
      y: 750,
      negotiationId: "quiosque2_beach_1",
      dialogs: [
        "Três porções de camarão pra mesa cinco! Ufa... O feriado nem começou e o quiosque já tá esse caos.",
        "A cozinha até dá conta, o meu verdadeiro gargalo é o caixa. A fila fica tão grande que o turista olha e desiste de comprar.",
        "Você é da Cielo? Olha, se for pra oferecer maquininha comum, eu dispenso. Eu preciso de tecnologia pesada pra acabar com essa fila!",
      ],
    },
  ],
  QuiosSurfScene: [
  ...
  MecanicaScene: [
    {
      ...
      dialogs: [
        "Olha só... camisa da Cielo? Achei que a dor de cabeça que vocês me deram já fosse o suficiente.",
        "Cancelei, devolvi a máquina, e o aluguel continuou caindo na minha conta por meses. Um desrespeito total.",
        "Se veio aqui tentar me empurrar maquininha nova, pode dar meia-volta. A menos que você saiba consertar essa bagunça primeiro...",
      ],
    },
  ],
  CentroMotorScene: [
