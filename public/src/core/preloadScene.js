...
export class PreloadScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.tilemapTiledJSON(
      "quiosquep-map",
      "assets/interiors/json/quiosquePraia.json",
    );
    this.load.image(
      "quiosquePraia-tiles",
    ...
    this.load.image(
      "lojadiversaop-tiles",
      "assets/interiors/pngs/lojasurf.png",
    );
    ...
    // ─── Mapas interiores da INDÚSTRIA ───
    this.load.tilemapTiledJSON(
      "centrodepecas-map",
      "assets/interiors/json/centrodepecas.json",
    );
    this.load.image(
      "centrodepecas-tiles",
      "assets/interiors/pngs/centrodepecas.jpeg",
    );

    this.load.tilemapTiledJSON(
      "centromotor-map",
      "assets/interiors/json/centromotor.json",
    );
    this.load.image(
      "centromotor-tiles",
      "assets/interiors/pngs/centromotor.png",
    );

    this.load.tilemapTiledJSON(
      "centrosuprimento-map",
      "assets/interiors/json/centrosuprimento.json",
    );
    this.load.image(
      "centrosuprimento-tiles",
      "assets/interiors/pngs/centrosuprimento.png",
    );

    this.load.tilemapTiledJSON(
      "galpaomergulho-map",
      "assets/interiors/json/galpaomergulho.json",
    );
    this.load.image(
      "galpaomergulho-tiles",
      "assets/interiors/pngs/galpaomergulho.jpeg",
    );

    this.load.tilemapTiledJSON(
      "mecanica-map",
      "assets/interiors/json/mecanica.json",
    );
    this.load.image("mecanica-tiles", "assets/interiors/pngs/mecanica.jpeg");

    this.load.tilemapTiledJSON(
      "secaohidraulica-map",
      "assets/interiors/json/secaohidraulica.json",
    );
    this.load.image(
      "secaohidraulica-tiles",
      "assets/interiors/pngs/secaohidraulica.png",
    );
